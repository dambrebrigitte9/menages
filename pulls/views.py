...
def adheration(request):
    if request.method == "POST":
        ...
        moment_pour_vous_contacter= request.POST.get('moment_pour_vous_contacter')
        ...
        service_choisis=service_choisis,moment_pour_vous_contacter=moment_pour_vous_contacter)
